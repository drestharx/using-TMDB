...
const likedMoviesSection = document.getElementById('favorites-section');
...
const favoritesMoviesListArticle = document.querySelector('#favorites-section .favorites__movie-list');
